...
[_QWERTY] = KEYMAP( \
  ...
  KC_LCTL, KC_LGUI, KC_LALT, MO(_FN),  LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_LOWER] = KEYMAP( \
  ...
  KC_DEL,  _______, KC_UNDS, _______, _______, _______, _______,   KC_UNDS,   KC_PLUS, _______, _______, KC_PIPE, \
...
[_RAISE] = KEYMAP( \
  ...
  KC_DEL,  _______,  KC_MINS, KC_LCBR, KC_LPRN, KC_LCBR, KC_RCBR, KC_RPRN, KC_LCBR, KC_PLUS, KC_EQL,  KC_BSLS, \
...
[_FN] =  KEYMAP( \
  ...
  _______, _______, _______, MO(_FN), _______, _______, _______, _______, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT \
),
