 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | LGUI   | LALT   |        | FN     | SPACE  | LEFT   | DOWN   | RIGHT  | SPACE  | FN     |        | RALT   | RGUI   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { _______, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_HOME, KC_DEL,  KC_PGUP, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT   },
  { KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_END,  KC_UP,   KC_PGDN, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT  },
  { KC_LCTL, KC_LGUI, KC_LALT, _______, MO(_FN), KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  MO(_FN), _______, KC_RALT, KC_RGUI, KC_RCTL  },
 },
 ...
 */
 ...
 [_FN] = { /* FUNCTION */
  ...
  { KC_CAPS, KC_MPLY, KC_MNXT, KC_MSTP, RGB_SAD, RGB_SAI, KC_P4,   KC_P5,   KC_P6,   KC_PLUS, _______, RESET,   BL_INC, _______, _______  },
  { KC_VOLD, KC_MUTE, KC_VOLU, KC_APP,  RGB_VAD, RGB_VAI, KC_P1,   KC_P2,   KC_P3,   KC_PENT, _______, _______, BL_DEC, _______, _______  },
  { _______, _______, RGB_TOG, _______, MO(_FN), RGB_MOD, KC_P0,   _______, KC_PDOT, KC_PENT, MO(_FN), _______, _______, _______, _______  },
 }
